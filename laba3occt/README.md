...
✅ **Форматирование:**
- команды в блоках ```powershell``` — подсветка синтаксиса;
- вывод команд — в блоках ``` без языка для сохранения колонок;
- выглядит ровно в GitHub, VS Code, Notion и PDF-экспорте.
